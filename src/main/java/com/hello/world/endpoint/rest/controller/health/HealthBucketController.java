...
import static com.hello.world.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import com.hello.world.PojaGenerated;
import com.hello.world.file.bucket.BucketComponent;
import com.hello.world.file.hash.FileHash;
import java.io.File;
