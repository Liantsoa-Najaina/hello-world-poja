package com.hello.world.endpoint.event.model;

import static com.hello.world.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import com.hello.world.PojaGenerated;
import com.hello.world.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "com.hello.world.event1";
    return "com.hello.world.event2";
  }
}
